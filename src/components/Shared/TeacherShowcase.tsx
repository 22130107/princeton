...
export default function TeacherShowcase({
  ...
  return (
    <div className="mx-auto grid max-w-[1180px] items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
      <figure className="about-luxury-rise relative">
        <div
          aria-hidden
          className="absolute inset-0 translate-x-1 translate-y-1 bg-[#991B1B]/10"
        />
        <div className="relative border border-[#991B1B] bg-white p-3">
          <div className="relative aspect-[0.92/1] overflow-hidden bg-[#e2dbd9] md:aspect-[0.94/1]">
            {activeTeacher.icon ? (
              <CoverImage
      ...
      <div className="about-luxury-rise max-w-[560px] [animation-delay:120ms]">
