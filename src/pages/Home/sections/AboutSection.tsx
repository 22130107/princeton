  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-medium justify-center leading-[0] relative shrink-0 text-[#620000] text-[18px] w-full">
        <p className="leading-[26px]">Trường Mầm non Princeton thuộc Hệ thống Trường Princeton. là nơi mang đến môi trường giáo dục hiện đại, năng động, hướng đến mục tiêu đào tạo nên những thế hệ học sinh phát triển toàn diện, có nhân cách tốt, giàu bản lĩnh và có khả năng tạo nên những giá trị tích cực cho xã hội khi trưởng thành.</p>
      </div>
    </div>
  );
}
...
function WebKindergarten2Jpg() {
  return (
    <div
      ...
      style={{
        maskImage: `url("${imgWebKindergarten2Jpg}")`,
        WebkitMaskImage: `url("${imgWebKindergarten2Jpg}")`,
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-full left-[-16.23%] max-w-none top-0 w-[132.47%]" src={imgWebKindergarten2Jpg1} />
      </div>
    </div>
  );
}
    ...
    <div className="h-[370px] relative shrink-0 w-[414px]" data-name="Mask Group">
      <div
        ...
        style={{
          ...
          WebkitMaskImage: `url("${imgBackground2}")`,
...
function WebKindergartenJpg() {
  return (
    <div
      ...
      style={{
        maskImage: `url("${imgWebKindergartenJpg}")`,
        WebkitMaskImage: `url("${imgWebKindergartenJpg}")`,
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-full left-[-16.71%] max-w-none top-0 w-[133.42%]" src={imgWebKindergartenJpg1} />
      </div>
    </div>
  );
}
