...
const CARDS = [
  {
    ...
    description:
      "Với học phí chỉ từ 10 triệu đồng/tháng, trẻ được tiếp cận chương trình giáo dục Bang Princeton giúp phát triển toàn diện.",
  },
  {
    icon: iconSongNgu,
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10">
        <img alt="" className="absolute inset-0 size-full object-cover" src={imgBackground1} />
      </div>
      ...
      <div className="content-stretch flex flex-col items-center text-center gap-4 max-w-[900px] z-10 mt-8">
        ...
        <p className="font-medium text-[#333333] text-[18px] leading-[26px]">
          Trở thành học sinh của Trường Mầm non Princeton, các em sẽ được sinh hoạt và học tập trong môi trường tràn đầy tình yêu thương và sự thấu hiểu. Đó là nền tảng để mỗi bạn nhỏ phát triển mạnh mẽ trong suốt hành trình học tập.
        </p>
      </div>
        ...
        {CARDS.map((card, idx) => (
          ...
          >
            <div className="w-[96px] h-[96px] flex items-center justify-center mb-3 shrink-0">
              <img alt={card.title} className="max-w-full max-h-full object-contain" src={card.icon} />
            </div>
