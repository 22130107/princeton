  ...
  return (
    <div className="aspect-[154/154] max-w-[154px] relative shrink-0 w-full" data-name="teaching-method-item-1.png">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgTeachingMethodItem1Png} />
      </div>
    </div>
  );
}
...
function TeachingMethodItem3Png() {
  return (
    <div className="aspect-[154/154] max-w-[154px] relative shrink-0 w-full" data-name="teaching-method-item-3.png">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgTeachingMethodItem3Png} />
      </div>
    </div>
  );
}
...
function TeachingMethodItem2Png() {
  return (
    <div className="aspect-[154/162.44000244140625] max-w-[154px] relative shrink-0 w-full" data-name="teaching-method-item-2.png">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgTeachingMethodItem2Png} />
      </div>
    </div>
  );
}
...
function TeachingMethodItem4Png() {
  return (
    <div className="aspect-[154/154] max-w-[154px] relative shrink-0 w-full" data-name="teaching-method-item-4.png">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgTeachingMethodItem4Png} />
      </div>
    </div>
  );
}
...
function TeachingMethodPlanePng() {
  return (
    <div className="absolute inset-[102%_0_-9.65%_992px]" data-name="teaching-method-plane.png">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgTeachingMethodPlanePng} />
      </div>
    </div>
  );
}
    ...
    <div className="absolute bg-[#b80000] content-stretch flex flex-col items-start left-0 pb-[132px] pt-[100px] px-[104px] right-0 top-[2776px]" data-name="Section">
      ...
      <div className="absolute bottom-0 flex h-[25px] items-center justify-center left-0 right-0" style={{ containerType: "size" }}>
        <div className="flex-none h-[100cqh] rotate-180 w-[100cqw]">
          <div className="bg-size-[176px_25px] bg-top-left relative size-full" style={{ backgroundImage: `url("${imgImage1}")` }} data-name="Image" />
        </div>
      </div>
    </div>
  );
