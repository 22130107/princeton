...
import imgFacility2Jpg from "../../../assets/d7d7345887319e335a13681880e24de534f764ac.png";
import imgFacility1Jpg from "../../../assets/92e5ee994003ec00eae4b6020ca15de704cd6220.png";
import imgFacility3Jpg from "../../../assets/2f18e7a31d31b9b85df3a6588823571bdaf40d53.png";
import imgFacility1Jpg1 from "../../../assets/d39c1aff5a677c90942c7d65b7625cfdffcc35a1.png";
import imgBackground3 from "../../../assets/bcdc4bfb11a672185bf5895542f616cb4b9244ae.png";
import imgFacility5Jpg from "../../../assets/7efd1e9d3acc8ad92010b05849be05d4e2943353.png";
import imgFacility4Jpg from "../../../assets/d442605c9e1be0223245da5e9e29abf7ea1bef64.png";
...
function Container148() {
  return <div className="relative shrink-0 size-[308px]" data-name="Container" />;
}
...
function MaskGroup3() {
  return (
    <div className="-translate-x-1/2 absolute bottom-[-2.6%] left-1/2 top-[-2.6%] w-[324px]" data-name="Mask Group">
      <div className="-translate-x-1/2 absolute aspect-[324/324] bg-white bottom-0 left-1/2 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[324px_324px] top-0" style={{ maskImage: `url("${imgBackground3}")` }} data-name="Background" />
    </div>
  );
}
...
function Facility1Jpg() {
  return (
    <div className="absolute left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[308px_308px] size-[308px] top-0" style={{ maskImage: `url("${imgFacility1Jpg}")` }} data-name="facility-1.jpg">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-full left-[-24.99%] max-w-none top-0 w-[149.98%]" src={imgFacility1Jpg1} />
      </div>
    </div>
  );
}

function ImgMaskGroup5() {
  return (
...
function Facility2Jpg() {
  return (
    <div className="absolute left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[308px_308px] size-[308px] top-0" style={{ maskImage: `url("${imgFacility1Jpg}")` }} data-name="facility-2.jpg">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-full left-[-25.02%] max-w-none top-0 w-[150.04%]" src={imgFacility2Jpg} />
      </div>
    </div>
  );
}

function ImgMaskGroup6() {
  return (
    <div className="max-w-[308px] relative shrink-0 size-[308px]" data-name="Img:mask-group">
      <Facility2Jpg />
    </div>
...
function Facility3Jpg() {
  return (
    <div className="absolute left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[308px_308px] size-[308px] top-0" style={{ maskImage: `url("${imgFacility1Jpg}")` }} data-name="facility-3.jpg">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-full left-[-24.99%] max-w-none top-0 w-[149.98%]" src={imgFacility3Jpg} />
      </div>
    </div>
  );
}

function ImgMaskGroup7() {
  return (
    <div className="max-w-[308px] relative shrink-0 size-[308px]" data-name="Img:mask-group">
      <Facility3Jpg />
    </div>
...
function Facility4Jpg() {
  return (
    <div className="absolute left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[308px_308px] size-[308px] top-0" style={{ maskImage: `url("${imgFacility1Jpg}")` }} data-name="facility-4.jpg">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-full left-[-25.02%] max-w-none top-0 w-[150.04%]" src={imgFacility4Jpg} />
      </div>
    </div>
  );
}

function ImgMaskGroup8() {
  return (
    <div className="max-w-[308px] relative shrink-0 size-[308px]" data-name="Img:mask-group">
      <Facility4Jpg />
    </div>
...
function Facility5Jpg() {
  return (
    <div className="absolute left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[308px_308px] size-[308px] top-0" style={{ maskImage: `url("${imgFacility1Jpg}")` }} data-name="facility-5.jpg">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-full left-[-25.02%] max-w-none top-0 w-[150.04%]" src={imgFacility5Jpg} />
      </div>
    </div>
  );
}

function ImgMaskGroup9() {
  return (
    <div className="max-w-[308px] relative shrink-0 size-[308px]" data-name="Img:mask-group">
      <Facility5Jpg />
    </div>
    ...
    function tick(time: number) {
      if (isVisible) {
        ...
        if (!isDragging.current) {
          ...
          if (totalX.current < -(SET_WIDTH * 3)) {
            totalX.current += SET_WIDTH * 3;
          }
        }
        if (divRef.current) {
